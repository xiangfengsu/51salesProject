  ...
  export default {
    ...
    effects: {
      *fetch({ payload }, { call, put }) {
        const response = yield call(queryPost, payload, "/membertagentity/list");
        if (response) {
      ...
      *update({ payload }, { call, put, select }) {
        ...
        const response = yield call(update, payload, "/membertagentity/update");
        yield put({
          type: "changgeConfirmLoading",
          payload: {
            confirmLoading: false
      ...
      *add({ payload }, { call, put }) {
        ...
        const response = yield call(create, payload, "/membertagentity/save");
        yield put({
          type: "changgeConfirmLoading",
          payload: {
            confirmLoading: false
      ...
      *remove({ payload }, { call, put, select }) {
        ...
        Object.assign(payload, { page });
        const response = yield call(remove, payload, "/membertagentity/del");
        if (response) {
          const { code , body, } = response;
          if (code === 200) {
            yield put({
