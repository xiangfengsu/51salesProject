  ...
  export default class Index extends PureComponent {
      ...
      queryParamsFormater = (fields, type) => {
        ...
        const { data: { pagination } } = this.props.category;
      ...
      renderTable = () => {
        ...
        const { data: { list, pagination } } = category;
      ...
      render() {
        ...
        const { category: { modalVisible, confirmLoading } } = this.props;
